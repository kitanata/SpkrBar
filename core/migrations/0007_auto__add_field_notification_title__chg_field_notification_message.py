...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_notification', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Notification', max_length=140),
                      keep_default=False)


        # Changing field 'Notification.message'
        db.alter_column(u'core_notification', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):
        # Deleting field 'Notification.title'
        db.delete_column(u'core_notification', 'title')


        # Changing field 'Notification.message'
        db.alter_column(u'core_notification', 'message', self.gf('django.db.models.fields.CharField')(max_length=300))
