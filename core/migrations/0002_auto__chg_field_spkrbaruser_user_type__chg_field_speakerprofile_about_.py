...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpkrbarUser.user_type'
        db.alter_column(u'core_spkrbaruser', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SpeakerProfile.about_me'
        db.alter_column(u'core_speakerprofile', 'about_me', self.gf('django.db.models.fields.CharField')(max_length=4000))

        # Changing field 'EventProfile.description'
        db.alter_column(u'core_eventprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=4000))

        # Changing field 'AttendeeProfile.about_me'
        db.alter_column(u'core_attendeeprofile', 'about_me', self.gf('django.db.models.fields.CharField')(max_length=4000))

    def backwards(self, orm):

        # Changing field 'SpkrbarUser.user_type'
        db.alter_column(u'core_spkrbaruser', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'SpeakerProfile.about_me'
        db.alter_column(u'core_speakerprofile', 'about_me', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'EventProfile.description'
        db.alter_column(u'core_eventprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=800))

        # Changing field 'AttendeeProfile.about_me'
        db.alter_column(u'core_attendeeprofile', 'about_me', self.gf('django.db.models.fields.CharField')(max_length=500))
