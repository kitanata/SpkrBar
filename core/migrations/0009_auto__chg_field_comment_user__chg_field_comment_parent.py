...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.SpkrbarUser']))

        # Changing field 'Comment.parent'
        db.alter_column(u'core_comment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Comment']))

    def backwards(self, orm):

        # Changing field 'Comment.user'
        db.alter_column(u'core_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SpkrbarUser'], null=True))
