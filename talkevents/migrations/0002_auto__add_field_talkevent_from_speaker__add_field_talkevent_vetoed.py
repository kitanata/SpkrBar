...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkEvent.from_speaker'
        db.add_column(u'talkevents_talkevent', 'from_speaker',
    ...
    def backwards(self, orm):
        # Deleting field 'TalkEvent.from_speaker'
        db.delete_column(u'talkevents_talkevent', 'from_speaker')
    ...
    models = {
        ...
        'talkevents.talkeventsubmission': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)'}),
