...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkComment.new_comment'
        db.add_column(u'talks_talkcomment', 'new_comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Comment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TalkComment.new_comment'
        db.delete_column(u'talks_talkcomment', 'new_comment_id')
