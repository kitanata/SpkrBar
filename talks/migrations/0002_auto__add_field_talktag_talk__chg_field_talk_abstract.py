...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkTag.talk'
        db.add_column(u'talks_talktag', 'talk',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['talks.Talk']),
                      keep_default=False)


        # Changing field 'Talk.abstract'
        db.alter_column(u'talks_talk', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=4000))

    def backwards(self, orm):
        # Deleting field 'TalkTag.talk'
        db.delete_column(u'talks_talktag', 'talk_id')


        # Changing field 'Talk.abstract'
        db.alter_column(u'talks_talk', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=800))
    ...
    models = {
        ...
        'talks.talk': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'otags'", 'symmetrical': 'False', 'to': "orm['talks.TalkTag']"})
        },
        'talks.talkcomment': {
